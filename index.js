...
function rendercard(preview,name,brand,price,){
...
mainCard.appendChild(img_div);

var img_ = document.createElement('img');
img_.src = preview;
img_.alt = "Preview Image"
...
details.appendChild(heading_3);

var heading_4 = document.createElement('h4');
heading_4.innerHTML = brand;
details.appendChild(heading_4);

var heading_5 = document.createElement('h5');
heading_5.innerHTML = "Rs "+price;
details.appendChild(heading_5);
...
{
  rendercard(productList[pos].preview,
...
/*-------------------------------------- */
function rendercard_2(preview,name,brand,price,){
...
{
  rendercard_2(productList[pos].preview,
            productList[pos].name,
            productList[pos].brand,
            productList[pos].price,
            );
